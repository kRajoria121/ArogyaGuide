      ...
      try {
        ...
        const chat = model.startChat({
          history: [
            {
              role: "user",
             text: "Your name is ArogyaGuide and It's fixed. You will answer only health-related questions, if you are asked questions that are not related to health, medical, or well-being you will politely answer to ask you health-related questions and answer with drugs and medicine. and if user ask about you tell that im ArogyaGuide"
          
            },
            {
              role: "model",
              text: "Understood. I am ArogyaGuide, your dedicated healthcare AI assistant. I'm here to help you with any questions related to health, medical conditions, treatments, or wellness Only. If you have any questions about your health or want to learn more about a specific health topic, please feel free to ask. If your question is not related to health, I will kindly ask you to rephrase it to be about a health related topic. I am here to support you on your health journey!",
            },
          ],
          generationConfig: {
            maxOutputTokens: 100,
      ...
      <div className="lg:col-span-2 lg:ml-4 w-full mx-auto p-6 bg-gray-800 rounded-lg shadow-lg">
        ...
        <div className="h-96 overflow-y-scroll mb-4 p-4 bg-gray-700 rounded-lg">
          {chatHistory.map((message, index) => (
            ...
            >
              <strong>
                {message.role === "user" ? "User Prompt:" : "ArogyaGuide:"}
              </strong>
              <hr className="my-2" />
